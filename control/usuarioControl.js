...
function prueba(req, res) {
    res.status(200).send({
        "titulo" : "Alma lecciones de caracter",
        "genero" : "Novela, poesia, cuento",
        "autor" : "Laura Martinez Mendez, Fernando Linarez Guzman",
        "editorial" : "Editorial Tlacuache",
        "año" : "2018",
        "descripcion" : "Alma lecciones de carácter, un libro del Dr. O. L Tilghman, publicado en 1924 a sus casi ya cien años sigue mostrando valores y recomendaciones del alma y carácter aplicables a nuestras generaciones que piden a gritos regresar al uso y la practica de valores.Alma lecciones de carácter forma parte de la \"colección 1900\", donde la Editorial Tlacuache se da la tarea de rescatar libros editados en 1900, y que son parte de la historia de la humanidad.\n",
        "portada" : "http://localhost:4001/api/verportada/OmM836k9pbu4TFvvxWXnTosS.png",
    });
}
/*
